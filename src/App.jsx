      ...
      <>
        ...
        <nav>
          <div className="container ">
            <div className="flex">
              <img src="/Images/Frame 57.png" alt="frene57" />
              <ul>
                <li>
                  <a href="#">CATALOGUE</a>
                </li>
        ...
        <section id="banner">
          <div className="container">
            <div className="banner_fast">
              <div className="flex">
                <div className="flex_left">
                  <div className="banner_text">
                    <div className="banner_text_fast">
                      <h1> LET’S</h1>
                    </div>
                    <h2>EXPLORE</h2>
                ...
                <div className="flex_right">
                  <img
                    className="main"
                    src="/Images/incendiary-fantastically-beautiful-girl-coat-eco-fur-moves-fun-picture-lovely-lady-pink-clothes-removebg-preview 1.png"
                    alt=""
                  />
                  <img
                    className="one"
        ...
        <section id="logo">
          <div className="container">
            <div className="flex">
              <img
                src="/Images/Rectangle_36-removebg-preview.png"
                alt=""
              />
              <img
                src="/Images/Rectangle_44-removebg-preview.png"
                alt=""
              />
              <img
                src="/Images/Rectangle_38-removebg-preview.png"
                alt=""
              />
              <img
                src="/Images/Rectangle_43-removebg-preview.png"
                alt=""
              />
              <img
                src="/Images/Rectangle_45-removebg-preview.png"
                alt=""
              />
              <img
                src="/Images/Rectangle_41-removebg-preview.png"
                alt=""
              />
            </div>
          </div>
        ...
        <section id="PAYDAY">
          <div className="container">
            <div className="flex">
              <div className="payday_left">
                <img src="/Images/Group 105.png" alt="img" />
              </div>
              <div className="payday_right">
                <div className="text">
                  <h1>PAYDAY</h1>
                </div>
                <h2>SALE NOW</h2>
                ...
                <h4>1 December-10 December 2023</h4>
